      ...
      body: Column(
        children: [
          SizedBox(
            ...
            child: Lottie.asset(
              "assets/json/talking.json",
              animate: avatarState.isTalking, // Avatar moves when talking
            ),
          ),
          const SizedBox(height: 40),
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Center(
                // Logic updated: Show dots if listening OR talking
                child: (avatarState.isListening || avatarState.isTalking)
                    ? Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          animatingDot(12, 0.6, 0),
